...
- (void)saveMeasureMentDataWithRawPictureID:(NSString * _Nonnull)rawPictureID pictureID:(NSString * _Nonnull)pictureID data:(MeasurementData * _Nonnull)data json:(NSString * _Nonnull)json comment:(NSString * _Nonnull)comment;
...
SWIFT_CLASS("_TtC21ImageMeasureFramework9ImageInfo")
@interface ImageInfo : NSObject
/// 被测图片像素比率(pixels per mm in image)
...
SWIFT_CLASS("_TtC21ImageMeasureFramework18MeasureManagerView")
@interface MeasureManagerView : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
- (void)layoutSubviews;
...
@interface MeasureManagerView (SWIFT_EXTENSION(ImageMeasureFramework))
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
...
@interface MeasureManagerView (SWIFT_EXTENSION(ImageMeasureFramework)) <PopMenuViewControllerDelegate>
@end
...
SWIFT_CLASS("_TtC21ImageMeasureFramework15MeasurementData")
@interface MeasurementData : NSObject
/// 被测图片信息
@property (nonatomic, strong) ImageInfo * _Nonnull imageInfo;
/// 各测量项目信息
@property (nonatomic, copy) NSArray<RulerInfo *> * _Nonnull rulerInfos;
/// 匹配模版信息
@property (nonatomic, copy) NSArray<TemplateMatchInfo *> * _Nonnull matchedTemplates;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (NSString * _Nonnull)encode SWIFT_WARN_UNUSED_RESULT;
+ (MeasurementData * _Nullable)decodeWithJsonStr:(NSString * _Nonnull)jsonStr SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS("_TtC21ImageMeasureFramework13PatientRecord")
@interface PatientRecord : NSObject
@property (nonatomic, copy) NSString * _Nonnull name;
@property (nonatomic, copy) NSString * _Nonnull gender;
@property (nonatomic) NSInteger age;
@property (nonatomic, copy) NSString * _Nonnull measurementData;
@property (nonatomic, copy) NSString * _Nullable measured_picture;
@property (nonatomic, copy) NSString * _Nullable raw_picture;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC21ImageMeasureFramework9RulerInfo")
@interface RulerInfo : NSObject
/// 测量数据ID
...
- (nonnull instancetype)initWithId:(NSString * _Nonnull)id center:(CGPoint)center transform:(NSArray<NSNumber *> * _Nonnull)transform OBJC_DESIGNATED_INITIALIZER;
